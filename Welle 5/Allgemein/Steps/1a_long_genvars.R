...
dat_long_full <- 
  ...
  arrange(ID, Welle) %>%
  mutate(
    # Gewicht zum Wellenvergleich
    gewicht_w12345 = if_else(
      Welle == 5, Faktor2_w5, Faktor_w12345),
    hh_ue18_w12345 = case_when(
      # Welle 1
      Welle == 1 & S11_1_w1 < 99 ~ S11_1_w1-1,
      # Welle == 1 & S11_1_w1 == 99 ~ -7,
      # Welle 2
      !is.na(S11_1_w1[1]) & S11_1_w1[1] < 99 & Welle == 2 & !is.na(S1_w12345) ~ 
        as.double(S11_1_w1[1]-1),
      # Welle 3
      !is.na(S11_1_w1[1]) & S11_1_w1[1] < 99 & Welle == 3 & !is.na(S1_w12345) &
        S11_1_w3 == 0 ~ as.double(S11_1_w1[1]-1),
      !is.na(S11_1o_w34) & Welle == 3 ~ as.double(S11_1o_w34),
      # Welle 4
      !is.na(S11_1o_w34[3]) & is.na(S11_1o_w34[4]) & Welle == 4 & !is.na(S1_w12345)  ~ 
        as.double(S11_1o_w34[3]),
      !is.na(S11_1_w1[1]) & S11_1_w1[1] < 99 & Welle == 4 & !is.na(S1_w12345) &
        is.na(S11_1o_w34) & is.na(S11_1o_w34[3]) ~ as.double(S11_1_w1[1]-1),
      !is.na(S11_1o_w34)  & Welle == 4 ~ as.double(S11_1o_w34),
      # Welle 5
      !is.na(S11_1o_w34[4]) & is.na(S11_1_w5) & Welle == 5 & !is.na(S1_w12345)  ~ 
        as.double(S11_1o_w34[4]),
      !is.na(S11_1o_w34[3]) &  is.na(S11_1o_w34[4]) & is.na(S11_1_w5) & Welle == 5 & 
        !is.na(S1_w12345)  ~ as.double(S11_1o_w34[3]),
      is.na(S11_1o_w34[3]) &  is.na(S11_1o_w34[4]) & !is.na(S11_1_w1[1]) & 
        S11_1_w1[1] < 99 & Welle == 5 & !is.na(S1_w12345) &
    ...
    hh_ue14u18_w12345 = case_when(
      ...
      # Welle == 1 & S11_1_w1 == 99 ~ -7,
      # Welle 2
      !is.na(S11_2_w1[1]) & S11_2_w1[1] < 99 & Welle == 2 & !is.na(S1_w12345) ~ 
        as.double(S11_2_w1[1]-1),
      # Welle 3
      !is.na(S11_2o_w345) & Welle == 3 ~ as.double(S11_2o_w345),
      !is.na(S11_2_w1[1]) & S11_2_w1[1] < 99 & Welle == 3 & !is.na(S1_w12345) &
    ...
    hh_u14_w12345 = case_when(
      ...
      # Welle == 1 & S11_1_w1 == 99 ~ -7,
      # Welle 2
      !is.na(S11_3_w1[1]) & S11_3_w1[1] < 99 & Welle == 2 & !is.na(S1_w12345) ~ 
        as.double(S11_3_w1[1]-1),
      # Welle 3
      !is.na(S11_3o_w345) & Welle == 3 ~ as.double(S11_3o_w345),
      !is.na(S11_3_w1[1]) & S11_3_w1[1] < 99 & Welle == 3 & !is.na(S1_w12345) &
    ...
    hh_ue18_flag_w12345 = case_when(
      ...
      !is.na(S11_1o_w34[3]) &  is.na(S11_1o_w34[4]) & is.na(S11_1_w5) & Welle == 5 & 
        !is.na(S1_w12345)  ~ "Übertrag aus Welle 3",
      is.na(S11_1o_w34[3]) &  is.na(S11_1o_w34[4]) & !is.na(S11_1_w1[1]) & 
        S11_1_w1[1] < 99 & Welle == 5 & !is.na(S1_w12345) &
...
dat_long_full <- 
  ...
  mutate(
    ...
    add_i_w1235 = case_when(
      ...
      Welle == 2 & !is.na(S1_w12345) & (v_i[1] == 1| v_i[2] == 1) ~ 1,
      Welle == 3 & !is.na(S1_w12345) & (v_i[1] == 1 | v_i[2] == 1 | v_i[3] == 1) ~ 1,
      Welle == 5 & ziehung_w5 == 0 & !is.na(S1_w12345) & (v_i[1] == 1 | v_i[2] == 1 | v_i[3] == 1 | v_i[5] == 1) ~ 1,
      Welle == 5 & ziehung_w5 == 0 & !is.na(S1_w12345) & v_i[5] == 0 & v_i[1] == 0 & v_i[2] == 0 & v_i[3] == 0 ~ 0,
    ...
    add_hh_w1235 = case_when(
      ...
      Welle == 2 & !is.na(S1_w12345) & (v_hh[1] == 1| v_hh[2] == 1) ~ 1,
      Welle == 3 & !is.na(S1_w12345) & (v_hh[1] == 1 | v_hh[2] == 1 | v_hh[3] == 1) ~ 1,
      Welle == 5 & ziehung_w5 == 0 & !is.na(S1_w12345) & (v_hh[1] == 1 | v_hh[2] == 1 | v_hh[3] == 1 | v_hh[5] == 1) ~ 1,
      Welle == 5 & ziehung_w5 == 0 & !is.na(S1_w12345) & v_hh[5] == 0 & v_hh[1] == 0 & v_hh[2] == 0 & v_hh[3] == 0 ~ 0,
...
attributes(dat_long_full$gewicht_w12345)$label <- "Gewicht geeignet für Wellenvergleich"
