...
attributes(dat_long_full$Faktor_w12345)$label <- "Wellenspezifischer Gewichtungsfaktor"
attributes(dat_long_full$lfdn_W2_w2345)$label <- "Wellenspezifische ID"
attributes(dat_long_full$Interviewtag_w2345)$label <- "Datum des Interviews"
