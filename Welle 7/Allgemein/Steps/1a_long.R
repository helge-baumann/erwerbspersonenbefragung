...
abgleich <- openxlsx::read.xlsx(
  paste0(
    "Input/", 
    "2022-01-31_Erwerbspersonenbefragung_Abgleich-Welle1234567.xlsx"
  ), sheet=1, 
  startRow=2
)

names(abgleich) <- c("n1", "l1", "n2", "l2", "n3", "l3", "n4", "l4", "n5", "l5",
                     "n6", "l6", "n7", "l7", "erh", "iden", "anm")
...
attributes(dat_long_full$Faktor_w1234567)$label <- "Wellenspezifischer Gewichtungsfaktor"
attributes(dat_long_full$lfdn_W2_w234567)$label <- "Wellenspezifische ID"
...
attributes(dat_long_full$Faktor_voll_w57)$label <- "Gewichtungsfaktor inklusive Aufstockungsstichprobe (Selbständige Welle 5)"
