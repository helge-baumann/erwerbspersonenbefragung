# Daten Welle 6 einlesen
dat6 <- read_sav(
  "./Input/Boeckler_Corona_Welle6_2021_Kunde_1.sav")

# Namen und Labels extrahieren
names_labs <- map(dat6, function(x) attributes(x)$label)
write.csv2(enframe(unlist(names_labs)), "./Output/names_labs_w6.csv")
...
# Faktor Welle 5
dat5 <- dat5 %>% rename(Faktor_voll__5 = Faktor__5)
