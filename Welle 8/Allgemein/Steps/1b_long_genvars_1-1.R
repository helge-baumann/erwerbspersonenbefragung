# Änderung gegen v1-0: 
  # - Haushaltseinkommen an Welle 1 angepasst und vereinfacht (keine Individualeinkommen mehr)
  # - Arbeitszeiten (30.08.: noch ausstehend)
...
# Haushaltseinkommen; Anpassung an Vorschlag Jan Behringer 30.08.22 (Mail)
dat_long_full <- 
  dat_long_full %>%
  ungroup() %>%
  mutate(
    ...
    hh_income_w123578 = case_when(
      S10_w1 == 1 | D4_w2 == 1  | D4_w3578 == 1 ~ 400,
      S10_w1 == 2 | D4_w2 == 2  | D4_w3578 == 2 ~ 700,
      S10_w1 == 3 | D4_w2 == 3  | D4_w3578 == 3 ~ 1100,
      S10_w1 == 4 | D4_w2 == 4  | D4_w3578 == 4 ~ 1400,
      S10_w1 == 5 | D4_w2 == 5  | D4_w3578 == 5 ~ 1600,
      S10_w1 == 6 | D4_w2 == 6  | D4_w3578 == 6 ~ 1850,
      S10_w1 == 7 | D4_w2 == 7  | D4_w3578 == 7 ~ 2300,
      S10_w1 == 8 | D4_w2 == 8  | D4_w3578 == 8 ~ 2900,
      S10_w1 == 9 | D4_w2  == 9 | D4_w3578 %in% 9:10 ~ 3850,
      S10_w1 == 10 | D4_w2 %in% 10:11 | D4_w3578 %in% 11:12 ~ 5500 # wesentliche Änderung
     ), # KLassengrenzen
    hh_income_vor_w5 = 
      case_when(
          W5_D4a_w5 == 1  ~ 400,
          ...
          W5_D4a_w5 == 7  ~ 2300,
          W5_D4a_w5 == 8 ~ 2900,
        W5_D4a_w5 %in% 9:10  ~ 3850,
        W5_D4a_w5 %in% 11:12 ~ 5500
      ),
    hh_income_aeq_w123578 = hh_income_w123578/oecd_weight_w1234578,
...
attributes(dat_long_full$hh_income_w123578)$label <- "Haushaltseinkommen (Klassenmittelwerte)"
attributes(dat_long_full$hh_income_vor_w5)$label <- "Haushaltseinkommen vor der Krise (Klassenmittelwerte)"
attributes(dat_long_full$hh_income_aeq_w123578)$label <- "Haushaltsnettoäquivalenzeinkommen"
